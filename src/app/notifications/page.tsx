...
const notifications = [
  {
    id: 1,
    type: "jury",
    title: "Typography Jury Scheduled",
    message: "Your final jury for Typography Design is scheduled for Oct 18, 10:00 AM at Studio-1.",
    time: "2 hours ago",
    icon: Calendar,
  ...
  },
  {
    ...
    message: "Prof. R. Verma graded your Color Theory case study. You scored 18/20.",
    time: "Oct 12",
    icon: FileText,
